...
-- Step 5: Create function to check user balance for video
...
-- Step 6: Create function to reserve balance for video generation
...
BEGIN
    ...
    -- Update user balance (like existing system)
    ...
    -- Create billing record (consistent with existing system)
...
-- This should return data if successful
...
SELECT routine_name FROM information_schema.routines WHERE routine_name IN ('check_user_balance_for_video', 'reserve_balance_for_video', 'complete_video_generation');